...
/* Création de la fonction qui va vérifier les réponses */
function verifFunc(tabResultats){//va prendre toutes les résultats du tableau(a,b etc... et les comparer avec les réponses 
    for(let a=0; a<5; a++){
...
function afficherResultats(tabCheck) {//(tabCheck) tableau à vérifier
